...
import { validateActivityCreation, validateUpdatedActivityCreation } from '../../utils/validators.md';
...
router.put('/update-activity/:id', authenticationToken, validate(validateUpdatedActivityCreation), editAndUpdateActivity);
